...
function BuyingTickets({ navigation }) {
	...
	const handleSubmit = async () => {
		...
		try {
			...
			if (response.ok) {
				...
				setTicketUrls(urls);
				alert(
					"Biletler başarıyla oluşturuldu. PDF olarak görüntülemek için biletlerinize tıklayın."
				);
			} else {
	...
	return (
      ...
      />
      {isGeneratingTicket && (
        <Text style={styles.generatingTicketText}>Biletleriniz oluşturuluyor, lütfen bekleyiniz...</Text>
      )}
